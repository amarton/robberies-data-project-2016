var app = app || {
	...
	share: function(){
		...
		$(".icon-twitter").on("click", function(){
			...
			var tweet = "Examining Baltimore's 2016 increase in robberies"; //Tweet text
			var url = "http://data.baltimoresun.com/news/robberies2016/"; //Interactive URL
		...
		$(".icon-facebook").on("click", function(){
			...
			var picture = "http://data.baltimoresun.com/news/robberies2016/dist/images/facebook-thumb.png"; //Picture URL
			var title = "Baltimore Robberies"; //Post title
			var description = "Examining Baltimore's 2016 increase in robberies."; //Post description
			var url = "http://data.baltimoresun.com/news/robberies2016/"; //Interactive URL
